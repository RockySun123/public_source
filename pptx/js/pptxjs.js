(function ($) {
  $.fn.pptxToHtml = function (options) {
    ...
    function processSingleSlide(zip, sldFileName, index, slideSize) {
      ...
      RelationshipArray =
        slideLayoutResContent["Relationships"]["Relationship"];
      var masterFilename = "";
      var layoutResObj = {};
      if (RelationshipArray.constructor === Array) {
        for (var i = 0; i < RelationshipArray.length; i++) {
      ...
      RelationshipArray =
        slideMasterResContent["Relationships"]["Relationship"];
      var themeFilename = "";
      var masterResObj = {};
      if (RelationshipArray.constructor === Array) {
        for (var i = 0; i < RelationshipArray.length; i++) {
        ...
        switch (shapType) {
          ...
          case "curvedDownArrow":
            ...
            var d_val =
              ...
              shapeArc(wR, h, wR, h, cd2, cd2 + swAng3, false).replace(
                "M",
                "L"
              );
    ...
    function genBuChar(
      ...
      var lvl =
        parseInt(getTextByPathList(node["a:pPr"], ["attrs", "lvl"])) + 1;
      if (isNaN(lvl)) {
        lvl = 1;
      }
      ...
      var buFontSize = getTextByPathList(pPrNode, [
        "a:buSzPts",
        "attrs",
        "val",
      ]);
      ...
      if (marRNode !== undefined) {
        ...
        marRStr +=
          (marginRight + indent < 0 ? 0 : marginRight + indent) + "px;";
      }
    ...
    function genTable(node, warpObj) {
      ...
      var tblStyl = getTextByPathList(thisTblStyle, [
        "a:wholeTbl",
        "a:tcStyle",
      ]);
      ...
      for (var i = 0; i < trNodes.length; i++) {
        ...
        rowsStyl +=
          fontClrPr !== undefined ? " color: #" + fontClrPr + ";" : "";
    ...
    function genDiagram(node, warpObj, source, sType) {
      ...
      dgmQuickStyleFileName =
        warpObj["slideResObj"][dgmQuickStyleFileId].target;
    ...
    function getFontColorPr(
      ...
      if (color === undefined) {
        var layoutMasterNode = getLayoutAndMasterNode(
          pNode,
          idx,
          type,
          warpObj
    ...
    (tXml.simplify = function (t) {
      ...
      (tXml.toContentString = function (t) {
        ...
        return "object" == typeof t
          ? tXml.toContentString(t.children)
          : " " + t;
      }),
